									...
									<table id="dataTable" width="100%" cellspacing="0">
										...
										?>
											...
											<tr>
												...
												$querypro = mysqli_query($koneksi, "SELECT tb_antrian.no_antrian FROM tb_periksa, tb_poli, tb_antrian WHERE tb_poli.id_poli=tb_antrian.id_poli AND tb_periksa.id_poli=tb_poli.id_poli AND tb_periksa.id_user=tb_antrian.id_user AND tb_periksa.id_status_periksa=3 AND tb_periksa.id_poli=1 AND tb_antrian.id_poli=1 AND tb_periksa.tanggal_periksa=CURRENT_DATE() AND tb_antrian.tanggal=CURRENT_DATE() GROUP BY tb_periksa.id_periksa");
												while ($pro = mysqli_fetch_array($querypro)) {
													//var_dump($pro); die;
												?>
													<td>&nbsp;</td>
													<td align="center">
														<h2>A - <?php print_r($pro['no_antrian']); ?></h2>
													</td>
													<td>&nbsp;</td>
												<?php
											...
											<tr>
												<td>&nbsp;</td>
												<td align="center">
													<h5>Jumlah Antrian : <?php echo $drowumum[0]; ?></h5>
												</td>
												<td>&nbsp;</td>
											</tr>
											<TR>
									...
									<table id="dataTable" width="100%" cellspacing="0">
										...
										?>
											...
											<tr>
												...
												$sqlprogigi = mysqli_query($koneksi, "SELECT tb_antrian.no_antrian FROM tb_periksa, tb_poli, tb_antrian WHERE tb_poli.id_poli=tb_antrian.id_poli AND tb_periksa.id_poli=tb_poli.id_poli AND tb_periksa.id_user=tb_antrian.id_user AND tb_periksa.id_status_periksa=3 AND tb_periksa.id_poli=2 AND tb_antrian.id_poli=2 AND tb_periksa.tanggal_periksa=CURRENT_DATE() and tb_antrian.tanggal=CURRENT_DATE() GROUP BY tb_periksa.id_periksa");
												while ($progigi = mysqli_fetch_array($sqlprogigi)) {
												?>
													<td>&nbsp;</td>
													<td align="center">
														<h2>B - <?php print_r($progigi[0]); ?></h2>
													</td>
													<td>&nbsp;</td>
												<?php } ?>
											</tr>
											<tr>
												<td>&nbsp;</td>
												<td align="center">
													<h5>Jumlah Antrian : <?php echo $drowgigi[0]; ?></h5>
												</td>
												<td>&nbsp;</td>
											</tr>
											<TR>
