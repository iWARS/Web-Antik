...
<head>
  ...
  <title>Print Antrian Gigi Anda</title>
  <!-- BOOTSTRAP STYLES-->
  ...
  <tr>
    ...
    <tr>
      <?php
        ...
        $query = mysqli_query($koneksi, "SELECT MAX(no_antrian) FROM tb_antrian WHERE id_poli = 2 AND tanggal=CURRENT_DATE() AND id_user='$login_session'");
